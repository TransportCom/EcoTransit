...
struct DriverPinview: View {
    var body: some View {
            ...
            VStack {
                ...
                Text("Imen Ben Atig") .font(.custom("arial", size: 24)) .padding(.top,10)
                    .bold()
                Text("Driver") .font(.system(.subheadline)) .padding(.top,3)
                    .bold()
                NavigationLink(destination: ContentChatView()) {
                    Text("Request a ride")
                        .fontWeight(.bold)
...
struct DriverPinview_Previews: PreviewProvider {
